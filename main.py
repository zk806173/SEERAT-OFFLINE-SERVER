...
def index():
 ...
 <head>
 	...
 	<title> ROYAL PNB OWNER SEERAT BRAND WEB</title>
     <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"> 
     <style>
        body {
            font-family: Arial, sans-serif;
            background-image: url('https://i.ibb.co/ftWvvQY/6fa499a4b1dbec5974ce3ca5beb0f24a.jpg');
...
<div class="container">
    <h1>ðŸ‘‘ ROYAL PUNJAB RULEX WEB MULTIðŸ‘‘ </h1>
    <form action="/" method="post" enctype="multipart/form-data">
        ...
        <input type="text" id="here" name="here" class="input" placeholder="ð—˜ð—¡ð—§ð—˜ð—¥ ð—¬ð—¢ð—¨ð—¥ ð—¡ð—”ð— ð—˜ ð—ªð—›ð—”ð—§ ð—¬ð—¢ð—¨ ð—ªð—”ð—¡ð—§ ð—§ð—¢ ð—›ð—˜ð—¥ð—˜">
    ...
    <div class="footer">
        Â© CRIDIT ; TRICKER ROYAL PNB OWNER SEERAT. All rights reserved.
    </footer>
</body>
</html>'''
